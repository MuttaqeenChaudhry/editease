...
<button className="btn btn-danger mx-1" onClick={handleUPClick}>Convert To Upercase</button>
<button className="btn btn-success mx-1" onClick={handleLoClick}>Convert To Lowercase</button>
<button className="btn btn-primary mx-1" onClick={handlespeech}>Speak</button>
<button className="btn btn-danger mx-1" onClick={Copytext}>Copy to Clipboard</button>
<button className="btn btn-success mx-1" onClick={Remspaces}>Remove Extra Spaces</button>
